...
<script src="roleManJS.js"></script>
			...
			<div class="col-xs-12 col-sm-9">
				...
				<form id="pageForm">
					...
					<nav>
						<ul class="pager">
							<li>
								<a href="loadRoleDataAction?nowPage=${paging.nowPage-1}&pageSize=${paging.pageSize}" aria-label="Previous">
									<span aria-hidden="true">&laquo;</span>
								</a>
							</li>
							<c:forEach var="page" items="${pNList}">
								<li><a href="loadRoleDataAction?nowPage=${page}&pageSize=${paging.pageSize}">${page}</a></li>
							</c:forEach>
							<li>
								<a href="loadRoleDataAction?nowPage=${paging.nowPage+1}&pageSize=${paging.pageSize}" aria-label="Next">
